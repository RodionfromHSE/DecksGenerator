...
def read_reports(reports_dir: str) -> tp.List[tp.Dict[str, tp.Any]]:
    """
    Reads reports from reports_dir
    :param reports_dir: path to reports
    :return: list of reports
    """
    reports_names = os.listdir(reports_dir)
    reports_paths = [os.path.join(reports_dir, name) for name in reports_names]
    reports = []
